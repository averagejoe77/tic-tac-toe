...
Game.prototype.moveListener = function(square, idx) {
...
Game.prototype.checkResults = function(player, combos) {
	let match = false;
...
Game.prototype.endGame = function(player, isTie) {
...
Game.prototype.displayMsg = function(message) {
